...
void TrainSchedule::HandleBaseStates(Automata* aut) {
  Def().IfState(StRequestGreen)
      .IfReg0(routing_block_request_green_)
      .ActReg1(&routing_block_request_green_)
...
void TrainSchedule::AddDirectBlockTransition(const SignalBlock& source,
                                             ...
                                             bool eager) {
  AddBlockTransitionOnPermit(source, dest, nullptr, condition, eager);
}
...
void TrainSchedule::AddBlockTransitionOnPermit(const SignalBlock& source,
  ...
  */
  ...
  Def().IfState(StTestCondition2)
      .MaybeIfReg(has_permit, permit_request_, 1)
      .MaybeIfReg(has_permit, permit_granted_, 1)
