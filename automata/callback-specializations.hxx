...
template<class T> inline MCallbackSpec<T> NewCallback(T* obj, void (T::*fptr_t)()) {
...
template<class T, class B1> inline MCallbackSpec0_1<T, B1> NewCallback(T* obj, void (T::*fptr_t)(B1 b1), typename std::add_lvalue_reference<typename std::add_const<B1>::type>::type b1) {
...
template<class T, class B1, class B2> inline MCallbackSpec0_2<T, B1, B2> NewCallback(T* obj, void (T::*fptr_t)(B1 b1, B2 b2), typename std::add_lvalue_reference<typename std::add_const<B1>::type>::type b1, typename std::add_lvalue_reference<typename std::add_const<B2>::type>::type b2) {
...
template<class T, class P1> inline MCallbackSpec1_0<T, P1> NewCallback(T* obj, void (T::*fptr_t)(P1 p1)) {
...
template<class T, class B1, class P1> inline MCallbackSpec1_1<T, B1, P1> NewCallback(T* obj, void (T::*fptr_t)(B1 b1, P1 p1), typename std::add_lvalue_reference<typename std::add_const<B1>::type>::type b1) {
...
template<class T, class B1, class B2, class P1> inline MCallbackSpec1_2<T, B1, B2, P1> NewCallback(T* obj, void (T::*fptr_t)(B1 b1, B2 b2, P1 p1), typename std::add_lvalue_reference<typename std::add_const<B1>::type>::type b1, typename std::add_lvalue_reference<typename std::add_const<B2>::type>::type b2) {
...
template<class T, class P1, class P2> inline MCallbackSpec2_0<T, P1, P2> NewCallback(T* obj, void (T::*fptr_t)(P1 p1, P2 p2)) {
...
template<class T, class B1, class P1, class P2> inline MCallbackSpec2_1<T, B1, P1, P2> NewCallback(T* obj, void (T::*fptr_t)(B1 b1, P1 p1, P2 p2), typename std::add_lvalue_reference<typename std::add_const<B1>::type>::type b1) {
...
template<class T, class B1, class B2, class P1, class P2> inline MCallbackSpec2_2<T, B1, B2, P1, P2> NewCallback(T* obj, void (T::*fptr_t)(B1 b1, B2 b2, P1 p1, P2 p2), typename std::add_lvalue_reference<typename std::add_const<B1>::type>::type b1, typename std::add_lvalue_reference<typename std::add_const<B2>::type>::type b2) {
