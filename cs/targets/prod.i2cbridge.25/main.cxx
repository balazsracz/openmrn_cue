...
static const openlcb::NodeID NODE_ID = 0x050101011445ULL;
...
openlcb::AsyncIfCan g_if_can(&g_executor, &can_pipe, 3, 3, 2, 1, 1);
openlcb::DefaultNode g_node(&g_if_can, NODE_ID);
openlcb::EventIteratorFlow g_event_flow(&g_executor, 9);
