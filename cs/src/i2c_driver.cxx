...
#define SKIP_DRIVER
#elif defined(BOARD_BRACZ_ACC) || defined(BOARD_BRACZ_CS_TIVA) || defined(BOARD_BRACZ_CS_TIVA_SMALL) || defined(BOARD_BRACZ_RAILCOM) || defined(BOARD_LAUNCHPAD_EK) || defined(BOARD_NUCLEO_IO) || defined(BOARD_BUTTONLED_MSP) || defined(BOARD_RAILCOM_G0B1)
#define SKIP_DRIVER
#else
