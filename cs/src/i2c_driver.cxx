...
#define SKIP_DRIVER
#elif defined(BOARD_BRACZ_ACC) || defined(BOARD_BRACZ_CS_TIVA) || defined(BOARD_BRACZ_CS_TIVA_SMALL) || defined(BOARD_BRACZ_RAILCOM) || defined(BOARD_LAUNCHPAD_EK) || defined(BOARD_NUCLEO_IO)
#define SKIP_DRIVER
#else
